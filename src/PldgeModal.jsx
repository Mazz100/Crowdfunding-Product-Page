...
function PledgeModal({ cards, stock, title, defaultTitle, closeModal, completeState }) {
    ...
    function addPledge(event) {
        ...
        //Condition for no reward pledge
        else if (pledge !== '' && pledge !== 0) {
            ...
            <div className="pledge-form">
                ...
                <form action="" name="">
                    <div className="modal-input"
                        style=
                        {{
                            borderColor: selectedPledge === "Pledge with no reward" ||
                                selectedPledge === defaultTitle ? "hsl(176, 50%, 47%)" : null
                        }}>
                    ...
                    {cards.map(card => <div key={card.title} className="modal-input"
                        style=
                        {{
                            borderColor: selectedPledge === card.title ? "hsl(176, 50%, 47%)" : null,
